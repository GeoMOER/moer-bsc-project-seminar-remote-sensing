...
* a result section with details about your findings
...
# Feedback
Feedback on the outline will be given at the next session. 
On the one hand, it is necessary to submit the outline in time (by Thursday, 25.06.2026, at 12:00pm) so that there is enough time for the instructors to prepare feedback. 
